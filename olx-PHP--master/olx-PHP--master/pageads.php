        ...
        <div class="container">
            ...
            <div class="card">
                    <div class="row">
                        ...
                        <aside class="col-sm-7">
                            ...
                            <hr>
                                ...
                                <?php 
                               if (isLogged() == 1 && isset($_SESSION['loggedInUserId']) && isset($rowreport['UserID']) && $_SESSION['loggedInUserId'] !== $rowreport['UserID'])
                                {
                ...
                <?php
                    ...
                    // Get the phone number of the owner from the database
                    $ownerPhoneNumber = getOwnerPhoneNumber($AdsID); // Replace with the actual function to retrieve the owner's phone number

                    // Assuming $productId is the variable containing the product ID
                    $productId = $AdsID; // You can adjust this based on how you retrieve the product ID

                    // Create a link to open WhatsApp with a pre-filled message
                    $whatsappLink = "https://wa.me/$ownerPhoneNumber?text=Hello,%20I%20am%20interested%20in%20your%20product%20with%20ID:%20$productId.";

                    // Output the WhatsApp button/link
                    echo "<a href=\"$whatsappLink\" class=\"btn btn-success\">Chat on WhatsApp</a>";
                ?>
